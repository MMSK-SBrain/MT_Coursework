#!/usr/bin/env python3
"""
Convert YAML learning outcomes to Excel template
Reads: 03-learning-outcomes.yaml
Writes: 03-template.xlsx
"""
...
with open('03-learning-outcomes.yaml', 'r') as f:
